...
router.get("/sort", (req, res) => {
  console.log("Users before sorting:", users);  // Log users before sorting
  ...
  let sorted_users = users.sort(function (a, b) {
    ...
    console.log(`Parsed dates: ${d1} - ${d2}`);  // Log parsed dates
    return d1 - d2;  // Sort based on date difference
  });
  
  console.log("Users after sorting:", sorted_users);  // Log users after sorting
